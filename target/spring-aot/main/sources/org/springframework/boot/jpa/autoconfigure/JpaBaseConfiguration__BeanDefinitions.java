...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.finanzasbackend.modulos.categoria.CategoriaEntidad", "com.example.finanzasbackend.modulos.cuenta.CuentaEntidad", "com.example.finanzasbackend.modulos.deuda.DeudaEntidad", "com.example.finanzasbackend.modulos.transaccion.TransaccionEntidad", "com.example.finanzasbackend.modulos.usuario.UsuarioEntidad");
