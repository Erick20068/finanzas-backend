...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.UsuarioRepositorio.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CategoriaRepositorio.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DeudaRepositorio.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CuentaRepositorio.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.TransaccionRepositorio.fragments#0'.
     */
