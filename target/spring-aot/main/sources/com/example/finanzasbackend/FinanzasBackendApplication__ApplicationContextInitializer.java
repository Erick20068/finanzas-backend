 ...
 */
@Generated
public class FinanzasBackendApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new FinanzasBackendApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new FinanzasBackendApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.example.finanzasbackend.configuracion.ConfiguracionSeguridad");
